...
const select2 = document.querySelector(".selectinst2");
   ...
   // get the icons and sections


   const infoformBtn = document.getElementById("uppdate-info");
    const cancelinfoBtn = document.getElementById("cancel-info");
    const table = document.querySelector(".sectiontable");
    const infoform = document.querySelector(".profile-cardinfo");
  ...
  infoformBtn.addEventListener("click", () => {
    ...
    const editinfoformBtn = document.getElementById("update-infoform");
    const cancelEditinfoBtn = document.getElementById("cancel-upform");
    const infoforme = document.querySelector(".profile-cardinfo");
    const editinfoform = document.querySelector(".containerformupdate");
    
    editinfoformBtn.addEventListener("click", () => {
      infoforme.style.display = "none";
      editinfoform.style.display = "block";
    });
    
    cancelEditinfoBtn.addEventListener("click", () => {
      infoforme.style.display = "block";
    ...
    const changeButton = document.getElementById('create-btn');
    const section1 = document.getElementById('Request');
    const section2 = document.getElementById('internship');
    const cancelButton = document.getElementById('cancelsend');
